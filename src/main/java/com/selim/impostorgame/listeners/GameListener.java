...
public class GameListener implements Listener {
    ...
    public void onDeath(PlayerDeathEvent event) {
        ...
        // No death messages while a round is active (unless turned off in config)
        if (gm.isGameRunning() && plugin.getConfig().getBoolean("rules.block-death-messages", true)) {
    ...
    public void onEntityDeath(EntityDeathEvent event) {
        ...
        gm.endGame("messages.crewmates-win-dragon");
    }
}
